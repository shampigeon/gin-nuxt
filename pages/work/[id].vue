...
const { data, error } = await useAsyncData(`work-post:${postId}`, () => fetchPostDetails(postId))
...
<template>
  <div class="container py-4" style="max-width: 800px;">
    <NuxtLink to="/work" class="btn btn-sm btn-outline-secondary mb-4">← Назад</NuxtLink>
